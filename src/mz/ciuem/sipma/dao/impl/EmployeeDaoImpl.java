...
public class EmployeeDaoImpl extends GenericDaoImpl<Employee> implements EmployeeDao {
	...
	public List<Employee> allWhereUserIdIsNull() {
		...
		Query query = em.createQuery("select e from Employee e where e.userLogin is null");
//		query.setMaxResults(20);
	...
	public List<Employee> getAll() {
		...
		Query query = em.createQuery("select e from Employee e where e.name NOT LIKE 'Admin'");
	...
	public List<Employee> filterByOrgan(Organ organ) {
		...
		Query query = em.createQuery("select e from Employee e where e.organ = ?");
