...
public class ActionVM extends AbstractVM {
	...
	private List<SpecifiedAction> specifiedActionList;
	...
	public void init(@ContextParam(ContextType.VIEW) Component view) {
		...
		specifiedActionList = specifiedActionService.allWithBasedCalc(loggedOrgan);
		
		rubrics = rubricService.getAll();
		
		//superRubrics = superrubricService.getAllSuperRubric();
	...
	public void printActpO() throws JRException{
		if (rubrics.isEmpty()) {
			...
			mas.imprimir("/reports/planoOrcamental.jrxml", rubrics, m, modal);
	...
	public void printAct() throws JRException{
		if (specifiedActionList.isEmpty()) {
			...
			m.put("ano", ""+ac.getBeginDate().getYear());
			Div modal = (Div) ui.getFellow("modal");
			mas.imprimir("/reports/actividades2.jrxml", specifiedActionList, m, modal);
