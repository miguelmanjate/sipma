...
public abstract class AbstractCalendarModel extends SimpleCalendarModel {
	private static final long serialVersionUID = 1L;

	private String filterText = "";

	public AbstractCalendarModel(List<CalendarEvent> calendarEvents) {
	...
	public List<CalendarEvent> get(Date beginDate, Date endDate,
		...
		for (Iterator<?> itr = _list.iterator(); itr.hasNext();) {
			Object obj = itr.next();
			CalendarEvent ce = obj instanceof CalendarEvent ? (CalendarEvent) obj
					: null;
