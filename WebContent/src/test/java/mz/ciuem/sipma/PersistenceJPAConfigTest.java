...
@ComponentScan(basePackages = { "mz.ciuem.sipma.dao",
		"mz.ciuem.sipma.dao.impl", "mz.ciuem.sipma.service",
		"mz.ciuem.sipma.service.impl" })
public class PersistenceJPAConfigTest {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "mz.ciuem.sipma.entity" });
